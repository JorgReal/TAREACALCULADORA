...
public class Calculador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        gridBagConstraints.insets = new java.awt.Insets(40, 20, 0, 30);
        getContentPane().add(txtpantalla, gridBagConstraints);
        ...
        gridBagConstraints.ipady = 15;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(40, 10, 0, 30);
        getContentPane().add(jButton3, gridBagConstraints);

        jButton4.setBackground(new java.awt.Color(51, 153, 255));
        jButton4.setForeground(new java.awt.Color(255, 255, 255));
        jButton4.setText("C/E");
        ...
        gridBagConstraints.ipady = 15;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 60, 30);
        ...
        gridBagConstraints.ipady = 15;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 60, 0);
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        // TODO add your handling code here:
        String resultado;
        igual=txtpantalla.getText();
        
        if (!igual.equals("")){
        resultado=calculadora(numero,igual,signo);
        txtpantalla.setText(resultado);
        }
        
    }//GEN-LAST:event_jButton14ActionPerformed
   public static String calculadora(String numero,String igual,String signo){
        Double resultado=0.0;
        String respuesta;
        
        if (signo.equals("-")){
            resultado=Double.parseDouble(numero)-Double.parseDouble(igual);
        }
        if (signo.equals("+")){
            resultado=Double.parseDouble(numero)+Double.parseDouble(igual);
        }
